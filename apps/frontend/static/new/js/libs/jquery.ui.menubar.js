...
// there has to be just one item that has tabindex
    $.widget("ui.menubar", {
        ...
        _initializeMenubarsBoundElement: function() {
            this.element /*Quite la clase ui-widget-header*/
        ...
        _initializeItem: function($anItem, menubar) {
            ...
            if (menuItemHasSubMenu) {
                ...
                if (menubar.options.menuIcon) {
                    //aqui iba junto al principio un addClass con "ui-state-default" .addClass("ui-state-default");
        ...
        _applyDOMPropertiesOnItem: function($item, menubar) {
            $item
                    .addClass("ui-menu-button ui-widget ui-button-text-only ui-menubar-link")
                    .attr("role", "menuitem")
                    .wrapInner("<span class='ui-button-text'></span>");

            if (menubar.options.buttons) {
                //aqui iba junto al remove un addClass con "ui-state-default" .addClass("ui-state-default");
        ...
        _destroy: function() {
            ...
            this.items
                    .unbind(".menubar")
                    .removeClass("ui-menu-button ui-widget ui-button-text-only ui-menubar-link ui-state-default")
                    .removeAttr("role")
