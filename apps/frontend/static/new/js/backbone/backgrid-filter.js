/*
  ...
  Copyright (c) 2013 Jimmy Yuen Ho Wong and Rainer Segura Peña
...
function check(input) {
    ...
    if(input.validity.patternMismatch){
        ...
        input.setCustomValidity(gettext('The value is invalid.'));
    }
    else {
...
function checkER(input, typeER) {
       ...
       if (typeER == 1) {
            ...
            *
             * @type {RegExp} Email
            */
          var RegExp = /^[\w\-]{1,}([\w\-\+.]{1,1}[\w\-]{1,}){0,}[@][\w\-]{1,}([.]([\w\-]{1,})){1,3}$/;
            ...
            *
             * @type {RegExp} IP
            */
          var RegExp = /^[0-9]{1,}([.]([0-9]{1,})){0,3}$/;
       }

       if (RegExp.test(values) || values == "") {
             input.setCustomValidity("");
       } else {
             input.setCustomValidity(gettext('The value is invalid.'));
       }
...
(function (root, factory) {
  ...
  */
  var ServerSideFilter = Backgrid.Extension.ServerSideFilter = Backbone.View.extend({
    ...
    template: _.template('<span class="search">&nbsp;</span><input type="search" <% if (placeholder) { %> placeholder="<%- placeholder %>" <% } %> <% if (typeER == null) { %> oninput="check(this)" <% } else { %> oninput="checkER(this, <%- typeER %>)" <% }%>   <% if (pattern && typeER == null ) { %> pattern="<%- pattern %>" <% } %> name="<%- name %>" id="<%- name %>_input"/><a class="clear" data-backgrid-action="clear" href="#">&times;</a><a class="erase" data-backgrid-action="erase" href="#"><span class="ui-icon ui-icon-trash"></span></a>', null, {variable: null}),

    /** @property */
    events: {
      "keyup input[type=search]": "showClearButtonMaybe",
      "click a[data-backgrid-action=clear]": "clear",
      "click a[data-backgrid-action=erase]": "erase",
      "submit": "search"
    },
    ...
    */
    ...
    /**
       @property {string} [pattern] The HTML5 pattern
    */
    pattern: null,

   /**
      @property {string} [typeER] The Regular Expression
    */
    typeER: null,
    ...
    */
    initialize: function (options) {
      ...
      this.typeER = options.typeER || this.typeER;
     ...
     */
    searchBox: function () {
      return $.merge(this.$el.find("input[type=search]"),this.$el.find("select[type=search]"));
    },
